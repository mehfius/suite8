...
if($type=='image/jpeg' or $type=='image/png'){
	...
	$newnametarget_file 		= $array["pdf"].$newfilename;
	...
	if ($uploadOk == 0) {
		...
		if (move_uploaded_file($tmpname, $newnametarget_file)) {
			...
			echo json_encode(array('url' => $newnametarget_file, 'ext' => 'pdf','filename' => $newfilename));
...
function thumbnailjpg($dir,$img,$newdir,$width){
	...
	$image->save($newdir.$img,IMAGETYPE_JPEG,80,null);
